      ...
      <section className=" z-50">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
          ...
          <div className="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            ...
            <a
              href="https://youtu.be/tlXLwaZy0Uc"
        ...
        <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
         ...
         hover:border-pink-500/10 hover:shadow-pink-500/10"
          ...
          >
            ...
            <p className="mt-1 text-sm text-gray-600">
              AI will craft the questions or topics for you to focus on during
              the interview. It will customizes your interview questions to suit
              the role, industry, or skills you're targeting.
            </p>
          </a>
